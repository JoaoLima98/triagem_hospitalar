...
<body>
    <div class="container">
        ...
        <nav class="nav fade-in">
            ...
            <div class="nav-items">
                <a href="/dashboard" class="nav-item {{ Route::is('dashboard') ? 'active' : '' }}"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
                <a  href="{{ route('atendentes.index') }}" class="nav-item {{ Route::is('atendentes.*') ? 'active' : '' }}">
                    <i class="fas fa-pills"></i>Gerenciar Recepcionistas
                </a>
                <a href="{{ route('medicos.index') }}" class="nav-item {{ Route::is('medicos.*') ? 'active' : '' }}">
                    <i class="fas fa-user-md"></i>
                    Gerenciar Médicos
                </a>

                <a  href="{{ route('enfermeiros.index') }}" class="nav-item {{ Route::is('enfermeiros.*') ? 'active' : '' }}">
                    <i class="fas fa-user-md"></i>
                    Gerenciar Enfermeiro(a)s
                </a>
